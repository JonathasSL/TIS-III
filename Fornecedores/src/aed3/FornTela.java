...
public class FornTela extends JFrame {
...
//	 });
	 ...
	 String pessoa=txpessoa.getText();
	 String email=txemail.getText();
	 String telefone=txtelefone.getText();
		 
     Fornecedores obj = new Fornecedores(-1,nome,produto,pessoa,email,telefone);
