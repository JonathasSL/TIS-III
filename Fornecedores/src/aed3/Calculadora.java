...
//	 operacao = ' ';
	 ...
	 b.addActionListener(e -> {
		try {
			...
			FornecedoresCrud.incluirCliente(txnome.getText(),txproduto.getText(),txpessoa.getText(),txemail.getText(),txtelefone.getText());
		} catch (Exception e1) {
...
//	 });
	 ...
	 private void Incluir(String campo,String campo1,String campo2,String campo3,String campo4) throws Exception {
		 ...
		 FornecedoresCrud.incluirCliente(campo, campo1, campo2, campo3, campo4);
