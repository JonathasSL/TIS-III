...
public class Arquivo2 <T extends Entidade2> {
	 RandomAccessFile arquivo;
	    String nomeArquivo;
	    Constructor<T> construtor;
	    
	    public Arquivo2(Constructor<T> c, String n) throws Exception {
	        nomeArquivo = n;
	        construtor = c;
	    ...
	    public Entidade2 buscar(String nome) throws Exception {
