 ...
 * @author Projetos ES
 */
public class Incluir_Artista extends javax.swing.JFrame {

    /**
     * Creates new form Incluir_Cliente
     */
    public Incluir_Artista() {
        initComponents();
    }
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Incluir Artista");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Incluir_Artista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               ...
               new Incluir_Artista().setVisible(true);
            }
        });
    }
