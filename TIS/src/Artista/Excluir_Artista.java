 ...
 * @author Projetos ES
 */
public class Excluir_Artista extends javax.swing.JFrame {

    /**
     * Creates new form Incluir_Fornecedores
     */
    public Excluir_Artista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Artistas");

        jLabel2.setText("Digite o Nome do artista que deseja Excluir:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Excluir_Artista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Excluir_Artista().setVisible(true);
            }
        });
    }
