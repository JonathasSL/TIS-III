 ...
 * @author Projetos ES
 */
public class Menu_Fornecedor extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Cliente
     */
    public Menu_Fornecedor() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        Incluir_Fornecedor m=new Incluir_Fornecedor();
       m.setVisible(true);
            dispose(); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Fornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Fornecedor().setVisible(true);
            }
        });
    }
